...
package components.controller.serverCommands
{
	...
	public class SetScalerOutputScale extends ServerCommand
	{
		public function SetScalerOutputScale( scalerID:int, scale:String )
		{
			super();
		...
		public override function generateInverse( model:IntegraModel ):void
		{
			...
			pushInverseCommand( new SetScalerOutputScale( _scalerID, scaler.outScale ) );
		}
		...
		public override function executeServerCommand( model:IntegraModel ):void
		{
			...
			connection.addArrayParam( scalerPath.concat( "outScale" ) );
