...
package components.controller.serverCommands
{
	...
	*/
	...
	public class SetAvailableSampleRates extends ServerCommand
	{
		public function SetAvailableSampleRates( availableSampleRates:Vector.<int> )
		{
			super();

			_availableSampleRates = availableSampleRates;
		}
		...
		public override function execute( model:IntegraModel ):void
		{
			...
			audioSettings.availableSampleRates = _availableSampleRates;
		...
		{
			changedAttributes.push( model.getPathStringFromID( model.audioSettings.id ) + ".availableSampleRates" );
		}	
		
		private var _availableSampleRates:Vector.<int>;
	}
}
