...
namespace ntg_internal
{
	...
	void CSceneLogic::handle_new( CServer &server, ntg_command_source source )
	{
	...
	void CSceneLogic::handle_move( CServer &server, const CPath &previous_path, ntg_command_source source )
	{
