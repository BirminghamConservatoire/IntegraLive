...
package components.controller.serverCommands
{
	...
	*/
	...
	public class SetAvailableAudioDevices extends ServerCommand
	{
		public function SetAvailableAudioDevices( availableInputDevices:Vector.<String>, availableOutputDevices:Vector.<String> )
		{
			super();
		...
		{
			changedAttributes.push( model.getPathStringFromID( model.audioSettings.id ) + ".availableInputDevices" );
			changedAttributes.push( model.getPathStringFromID( model.audioSettings.id ) + ".availableOutputDevices" );
		}	
