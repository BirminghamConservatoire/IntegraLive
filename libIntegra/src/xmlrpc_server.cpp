...
static xmlrpc_value *ntg_xmlrpc_interfaceinfo_callback( CServer *server, const int argc, va_list argv)
{
	...
	origin_id_string = ntg_guid_to_string( &interface_definition->get_origin_guid() );
