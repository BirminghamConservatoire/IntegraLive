...
namespace ntg_internal
{
	...
	void CEnvelopeLogic::handle_new( CServer &server, ntg_command_source source )
	{
	...
	void CEnvelopeLogic::handle_rename( CServer &server, const string &previous_name, ntg_command_source source )
	{
	...
	void CEnvelopeLogic::handle_move( CServer &server, const CPath &previous_path, ntg_command_source source )
	{
	...
	void CEnvelopeLogic::handle_delete( CServer &server, ntg_command_source source )
	{
	...
	void CEnvelopeLogic::update_value( CServer &server )
	{
		//todo - implement
