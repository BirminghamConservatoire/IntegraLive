...
namespace ntg_internal
{
	...
	void CScalerLogic::handle_new( CServer &server, ntg_command_source source )
	{
	...
	void CScalerLogic::handle_rename( CServer &server, const string &previous_name, ntg_command_source source )
	{
	...
	void CScalerLogic::handle_move( CServer &server, const CPath &previous_path, ntg_command_source source )
	{
	...
	void CScalerLogic::handle_delete( CServer &server, ntg_command_source source )
	{
