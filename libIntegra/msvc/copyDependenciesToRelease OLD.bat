...
copy "..\..\libIntegra_dependencies\fftw-3.3.3\libfftw3f-3.dll" "..\..\build\Release\server\"
copy "..\..\libIntegra_dependencies\portaudio\build\msvc\Win32\Release\portaudio_x86.dll" "..\..\build\Release\server\"
copy "..\..\libIntegra_dependencies\portmidi\Release\portmidi.dll" "..\..\build\Release\server\"
copy "..\..\libIntegra_dependencies\libsndfile\bin\libsndfile-1.dll" "..\..\build\Release\server\"
