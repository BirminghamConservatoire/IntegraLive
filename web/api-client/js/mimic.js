...
XmlRpcRequest.prototype.send = function() {
	...
	// [DGS 10/07/14]
	// Amended to serialize XML data before sending 
	//	- XMLHTTPRequest.send(XMLDocument doc) in IE produces a BOM prefix
	//	- this appears to trip up the server's xmlrpc-c parsing logic
	var doc = Builder.buildDOM(xml_call);
