...
package components.controller.serverCommands
{
	...
	*/
	...
	public class SetAvailableMidiDrivers extends ServerCommand
	{
		public function SetAvailableMidiDrivers( availableDrivers:Vector.<String> )
		{
			super();
		...
		public override function execute( model:IntegraModel ):void
		{
			...
			midiSettings.availableDrivers = _availableDrivers;
		...
		{
			changedAttributes.push( model.getPathStringFromID( model.midiSettings.id ) + ".availableDrivers" );
		}	
